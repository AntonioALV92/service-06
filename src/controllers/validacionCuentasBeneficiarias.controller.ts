...
router.post("/validarCuentaBeneficiaria", wrap(async (req: Request, res: Response) => {
    const response = await got.post(routes.validacionCuentasBeneficiarias, {
...
export const validacionCuentasBeneficiariasController: Router = router;
